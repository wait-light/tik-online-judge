...
import top.adxd.tikonlinejudge.executor.service.IProblemTagService;
 ...
 */
@RestController
@RequestMapping("/executor/problem-tag")
public class ProblemTagController {
    ...
    @PostMapping("")
    public CommonResult save(@RequestBody ProblemTag entity) {
        return  problemTagService.save(entity) ?
    ...
    public CommonResult deleteBatch(@RequestBody Long[] ids){
        return problemTagService.removeByIds(Arrays.asList(ids)) ?
    ...
    @PutMapping("/{id}")
    public CommonResult update(@RequestBody ProblemTag entity){
        return problemTagService.updateById(entity) ?
    ...
    public CommonResult info(@PathVariable("id") Long id){
        ProblemTag entity = problemTagService.getById(id);
        return entity != null ?
