 ...
 */
@Configuration
@ConfigurationProperties("tik-online-judge.executor.docker-cpp")
public class CppDockerConfig implements ICompileAbleConfig, IDockerJudgeConfig, InitializingBean {
    /**
     * 以下文件可配置
     * 源码文件地址
     */
    ...
    public CppDockerConfig(String path, String containerName, String imageName, String workDir) {
        this.path = path;
