...
import top.adxd.tikonlinejudge.executor.service.ILanguageService;
 ...
 */
@RestController
@RequestMapping("/executor/language")
public class LanguageController {
    ...
    @PostMapping("")
    public CommonResult save(@RequestBody Language entity) {
        return  languageService.save(entity) ?
    ...
    public CommonResult deleteBatch(@RequestBody Long[] ids){
        return languageService.removeByIds(Arrays.asList(ids)) ?
    ...
    public CommonResult delete(@PathVariable("id") Long id){
        return languageService.removeById(id) ?
            CommonResult.success().setMsg("删除成功") :
            CommonResult.error().setMsg("删除失败");
    }

    @PutMapping("/{id}")
    public CommonResult update(@RequestBody Language entity){
        return languageService.updateById(entity) ?
    ...
    public CommonResult info(@PathVariable("id") Long id){
        Language entity = languageService.getById(id);
        return entity != null ?
